...
#ifndef _MVISOR_AARCH64_MMU_H_
#define _MVISOR_AARCH64_MMU_H_
...
#define TT_S2_ATTR_MEMATTR_INNER_WB		(0b11 << 4)
...
#define TT_S2_ATTR_MEMATTR_NORMAL_INNER_NC	(0b00 << 2)
#define TT_S2_ATTR_MEMATTR_NORMAL_INNER_WT	(0b00 << 2)
#define TT_S2_ATTR_MEMATTR_NORMAL_INNER_WB	(0b00 << 2)

#define TT_S2_ATTR_AF 				(1 << 10)

#define TT_S2_ATTR_CONTIG 			(1 << 52)
#define TT_S2_ATTR_XN				(1 << 54)
