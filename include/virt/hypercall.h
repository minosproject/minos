...
#define HVC_VMBOX_ONLINE		HVC_VMBOX_FN(0)
#define HVC_VMBOX_OFFLINE		HVC_VMBOX_FN(1)
#define HVC_VMBOX_VRING_EVENT		HVC_VMBOX_FN(2)
#define HVC_VMBOX_IPC_EVENT		HCV_VMBOX_FN(3)
